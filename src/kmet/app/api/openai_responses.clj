(ns kmet.app.api.openai-responses
  ...
  (:require
   ...
   [kmet.app.api.shared :refer [bash-execution-text content-text effort-value endpoint-url image-block? off-explicitly-null? request-headers responses-events-handler transport-error-message]]))
