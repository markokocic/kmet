(ns kmet.app.api.google-vertex
  ...
  (:require
   ...
   [kmet.app.api.google-generative-ai :refer [google-messages google-thinking-config]]
   [kmet.app.api.shared :refer [getenv request-headers responses-events-handler transport-error-message]]))
