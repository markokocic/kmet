(ns kmet.app.api.openai-completions
  ...
  (:require
   ...
   [kmet.app.api.shared :refer [endpoint-url max-tokens-key openai-messages openai-messages-with-reasoning openai-thinking-params request-headers transport-error-message usage-with-cost]]))
