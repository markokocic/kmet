...
| Initial providers | **opencode-go, opencode (Zen), deepseek, github-copilot, openai, xai** (Phase 11 added the responses wire API + the last two) |
...
| `:openai-responses` | cloudflare-ai-gateway (+), github-copilot (+) (gpt-5*/grok-4.5/oswe*/mai* — now generated), openai-codex, openai (+), xai (+), opencode (+) (`@ai-sdk/openai` npm models), opencode-go (+) |
